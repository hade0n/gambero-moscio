...
3. **CLAUDE.md** completo (questo file) — riferimento per ogni step successivo.
...
11. **Final review** contro CLAUDE.md, UI/UX Pro Max, palette, tono, requisiti funzionali, mobile-first, Vercel, accessibilità.
